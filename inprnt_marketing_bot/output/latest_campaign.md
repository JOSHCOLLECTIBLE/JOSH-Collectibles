# 🎨 Marketing Campaign: JOSH1 185 • In JOM's Room

**Artwork URL:** [https://www.inprnt.com/gallery/joshuadenouden/josh1-185-in-joms-room/](https://www.inprnt.com/gallery/joshuadenouden/josh1-185-in-joms-room/)
...
![JOSH1 185 • In JOM's Room](https://cdn.inprnt.com/thumbs/0e/09/0e0987061efad496c7687d1a300f050f@2x.jpg)

## 📌 Pinterest Pin Copy
- **Title:** `JOSH1 185 • In JOM's Room | JOSH¹ Archive Brutalist Photography`
- **Board:** `JOSH¹ Archive // Phygital Photography Prints`
- **Description:**
```text
Architectural geometry and urban stillness • Structural symmetry recorded in natural light • An archival record of institutional form. Common rarity asset in the JOSH¹ Archive ('JOSH1 185 • In JOM's Room'). Exclusively available as a limited edition Phygital Art piece, bridging Solana blockchain provenance (JOSHSHOOT.SOL) and a gallery quality physical print. Captured in Rotterdam (RTM) 🇳🇱. Crafted on museum grade 300gsm 100% cotton rag archival paper with custom pigment inks for lifetime color permanence via INPRNT. Explore global shipping: https://www.inprnt.com/gallery/joshuadenouden/josh1-185-in-joms-room/ • #UrbanGeometry #SolanaNFT #Industrial #ArchivalPrint
```

## 🐦 Twitter / X & Bluesky Post
```text
「 JOSH1 185 • In JOM's Room 」
...
#BrutalistArchitecture #FineArtPrint #OnChainArt #ArtCollector
```

## 📸 Instagram / Threads (Stagnant Account Revival Strategy)
> **Carousel Note:** 📌 CAROUSEL REVIVAL STRATEGY (Algorithmic reach hook):
• Slide 1: Full high res photograph ('JOSH1 185 • In JOM's Room')
...
JOSH1 185 • In JOM's Room
  ...
  Structural symmetry recorded in natural light
  An archival record of institutional form
  DRiP Provenance: Score 53.2 (Grade D • Rotterdam)
...
.
.
#INPRNT #ContemporaryCollector #JOSHSHOOTPRINTS #PhygitalArt
```

## 📂 GitHub Archive Journal (README & Releases Feature)
- **Suggested Title:** `JOSH¹ Asset Release: JOSH1 185 • In JOM's Room`
- **Markdown Block:**
```markdown
## 🏛️ JOSH¹ Archive Featured Asset: "JOSH1 185 • In JOM's Room"

<p align="center">
  <a href="https://www.inprnt.com/gallery/joshuadenouden/josh1-185-in-joms-room/"><img src="https://cdn.inprnt.com/thumbs/0e/09/0e0987061efad496c7687d1a300f050f@2x.jpg" alt="JOSH1 185 • In JOM's Room" width="600" /></a>
</p>
...
🔗 **[Collect the archive via INPRNT &rarr;](https://www.inprnt.com/gallery/joshuadenouden/josh1-185-in-joms-room/)**
```
